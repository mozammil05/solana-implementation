...
export const vaultAta = new PublicKey(
  "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"
);
export const userStake = new PublicKey(
  "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"
);

export const stakingAccount = new PublicKey(
  "8kzLjiLa8A7WXzWa52c8VDsSTiKeMJSoMPjqr2DjC5Sw"
);
